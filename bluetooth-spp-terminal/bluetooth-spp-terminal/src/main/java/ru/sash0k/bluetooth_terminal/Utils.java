...
public class Utils {
     ...
     * Set Key
     */
    public static void setKey(Context context, String address, String item) {
        final SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor =  settings.edit();
        editor.putString(Const.KEY + address, item);
        editor.apply();
        editor.commit();
    }
    // ============================================================================
     ...
     * Get Key
     */
    public static String getKey(Context context, String address) {
        final SharedPreferences settings = PreferenceManager.getDefaultSharedPreferences(context);
        return settings.getString(Const.KEY +  address, "");
    }
    // ============================================================================
